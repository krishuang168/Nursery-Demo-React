            ...
            <Row>
              <Col>
                ...
                <Row>
                  <Col>
                    <p>
                      <Link to="/catalog">Online purchase</Link> is available
                      24/7.{" "}
                    </p>
                    <p>
                      We currently only provide <strong>curbside</strong> pickup
                      service. <br />
                      No in-store shopping is allowed per Governor's
                      Stay-at-home order.{" "}
                    </p>
                    <img
                      id="coronavirus"
